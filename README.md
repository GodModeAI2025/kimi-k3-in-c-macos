...
Vorher stand hier, MLX halte die Gewichte im Unified Memory, und das ging zu weit: es gilt
für die üblichen MLX-Runner, nicht für MLX. Ein Gegenbeispiel auf derselben Grundlage ist
...
Spitzenspeicher bei einem Checkpoint von 19 GiB und rund 5 Token pro Sekunde.
...
1. **Den Upstream-Beitrag einreichen.** Der Drift ist am 4. September 2026 gemessen
   ...
   gegen `117e9d2` und textlich nachgemessen gegen `ac1584a`. Eingereicht ist er nicht,
   das ist der nächste Schritt und eine Handlung des Eigentümers:
   `beitrag/einreichen.sh`. Die Messung steht in [UPSTREAM.md](UPSTREAM.md).
